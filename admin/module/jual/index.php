							...
							<tr>
								...
								<td>
									...
									<a href="fungsi/hapus/hapus.php?jual=jual&id=<?php echo $isi['id_penjualan']; ?>&brg=<?php echo $isi['id_barang']; ?>
											&jml=<?php echo $isi['jumlah']; ?>" class="btn btn-danger"><i
												class="fa fa-times"></i>
									</a>
								</td>
							</tr>
					...
					<div id="kasirnya">
						<table class="table table-stripped">
							...
							<form method="POST" action="index.php?page=jual&nota=yes#kasirnya">
								...
								<tr>
									<td>Total Semua</td>
									<td><input type="text" class="form-control" disabled name="total"
									...
									<td>
										<button class="btn btn-success"><i class="fa fa-shopping-cart"></i> Bayar
										</button>
