...
?>
<a href="index.php?page=barang" class="btn btn-info mb-3"><i class="fa fa-angle-left"></i> Balik </a>
<h4>Edit Barang</h4>
			...
			<form action="fungsi/edit/edit.php?barang=edit" method="POST">
				<tr>
					...
					<td><input type="text" readonly="readonly" class="form-control"
							   value="<?php echo $hasil['id_barang']; ?>"
							   name="id"></td>
				</tr>
				<tr>
					<td>Kategori</td>
				...
				<tr>
					<td>Stok</td>
					<td><input type="number" class="form-control" value="<?php echo $hasil['stok']; ?>" name="stok">
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td></td>
					<td>
						<button class="btn btn-info"><i class="fa fa-edit"></i> Update Data</button>
					</td>
				</tr>
			</form>
		</table>
