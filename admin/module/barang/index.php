...
<button type="button" class="btn btn-info btn-md mr-2" data-toggle="modal" data-target="#myModal">
	...
	<div class="table-responsive">
		<table class="table table-bordered table-striped table-sm" id="example1">
			...
			<tr>
				...
				<th>
				<?php echo $totalStok; ?></td>
				<th>Rp.<?php echo number_format($totalBeli); ?>,-
				</td>
				<th>Rp.<?php echo number_format($totalJual); ?>,-
				</td>
...
<div id="myModal" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content" style=" border-radius:0px;">
			<div class="modal-header" style="background:#36b8cc;color:#fff;">
			...
			<form action="fungsi/tambah/tambah.php?barang=tambah" method="POST">
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-info"><i class="fa fa-plus"></i> Insert
						Data
					</button>
