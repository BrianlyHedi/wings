...
<form method="POST" action="fungsi/edit/edit.php?kategori=edit">
    <table>
        <tr>
            ...
            <td style="padding-left:10px;"><button id="tombol-simpan" class="btn btn-info"><i class="fa fa-edit"></i>
                    Ubah Data</button></td>
        </tr>
    </table>
</form>
...
<form method="POST" action="fungsi/tambah/tambah.php?kategori=tambah">
    <table>
        <tr>
            ...
            <td style="padding-left:10px;"><button id="tombol-simpan" class="btn btn-info"><i class="fa fa-plus"></i>
