        ...
        <div class="row justify-content-center">
            <div class="col-md-5 mt-5">
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-lg-5" style="height: 470px ">
                        <!-- Nested Row within Card Body -->
						<div class="p-5">
							<div class="text-center" style="margin-bottom: 80px ">
								<h4 class="h4 text-gray-900 mb-5"><b>LOGIN</b></h4>
							</div>
							<form class="form-login" method="POST">
								...
								<button class="btn btn-info btn-block" style="border-radius: 50px " name="proses" type="submit"><i
										class="fa fa-lock"></i>
									SIGN IN</button>
							</form>
							<!-- <hr>
